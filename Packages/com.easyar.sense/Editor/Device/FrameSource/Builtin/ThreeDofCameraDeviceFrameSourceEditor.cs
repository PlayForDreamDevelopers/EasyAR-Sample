...
namespace easyar
{
    [CustomEditor(typeof(ThreeDofCameraDeviceFrameSource), true)]
    class ThreeDofCameraDeviceFrameSourceEditor : FrameSourceEditor
    {
        ...
        protected override void DrawAdvancedOptions()
        {
            ...
            var fs = target as ThreeDofCameraDeviceFrameSource;
