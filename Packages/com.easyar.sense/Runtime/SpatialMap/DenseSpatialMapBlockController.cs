    ...
    public class DenseSpatialMapBlockController : MonoBehaviour
    {
        ...
        private void CopyMeshData(SceneMesh easyarMesh)
        {
            ...
            using (var indicesBuffer = easyarMesh.getIndicesIncremental())
            {
                ...
                using (var nb = normalBuffer.partition(Info.startPointOfVertex * 12, Info.numOfVertex * 12))
                {
                ...
                using (var ib = indicesBuffer.partition(Info.startPointOfIndex * 4, Info.numOfIndex * 4))
                {
