...
namespace easyar.arengineinterop
{
    ...
    internal abstract class RefBase : IDisposable
    {
    ...
    internal static partial class Detail
    {
        ...
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern CameraDeviceType easyar_arengineinterop_AREngineCameraDevice_type(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int easyar_arengineinterop_AREngineCameraDevice_cameraOrientation(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern OptionalOfVec2I easyar_arengineinterop_AREngineCameraDevice_size(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern double easyar_arengineinterop_AREngineCameraDevice_frameRateRangeLower(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern double easyar_arengineinterop_AREngineCameraDevice_frameRateRangeUpper(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
    ...
    internal enum AREngineCameraDeviceFocusMode
    {
        Auto = 0,
        Fixed = 1,
    }

    internal class AREngineCameraDevice : RefBase
    {
        ...
        public virtual CameraDeviceType type()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_arengineinterop_AREngineCameraDevice_type(cdata);
                return _return_value_;
            }
        }
        public virtual int cameraOrientation()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_arengineinterop_AREngineCameraDevice_cameraOrientation(cdata);
                return _return_value_;
            }
        }
        public virtual Optional<Vec2I> size()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_arengineinterop_AREngineCameraDevice_size(cdata);
                return _return_value_.map(p => p.has_value ? p.value : Optional<Vec2I>.Empty);
            }
        }
        public virtual double frameRateRangeLower()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_arengineinterop_AREngineCameraDevice_frameRateRangeLower(cdata);
                return _return_value_;
            }
        }
        public virtual double frameRateRangeUpper()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_arengineinterop_AREngineCameraDevice_frameRateRangeUpper(cdata);
                return _return_value_;
            }
        }
    ...
    internal enum AREngineDeviceListDownloadStatus
    {
        /// <summary>
        /// Download successful.
        /// </summary>
    ...
    /// </summary>
    internal class AREngineDeviceListDownloader : RefBase
    {
    ...
    /// </summary>
    internal class BufferDictionary : RefBase
    {
    ...
    internal enum CameraDeviceType
    {
        /// <summary>
        /// Unknown location
        /// </summary>
    ...
    /// </summary>
    internal enum MotionTrackingStatus
    {
        /// <summary>
    ...
    /// </summary>
    internal class CameraParameters : RefBase
    {
    ...
    internal class Engine
    {
        ...
        {
            if (Detail.easyar_arengineinterop_Engine_schemaHash() != 1052345963)
            {
    ...
    /// </summary>
    internal class InputFrame : RefBase
    {
