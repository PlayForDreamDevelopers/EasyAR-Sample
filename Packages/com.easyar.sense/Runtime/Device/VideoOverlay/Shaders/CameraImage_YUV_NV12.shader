...
Shader "EasyAR/CameraImage_YUV_NV12"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float4 rgb4444 = tex2D(_uvTexture, texcoordUV);
                float cb = rgb4444.b * 16 / 17 + rgb4444.a / 17;
                float cr = rgb4444.r * 16 / 17 + rgb4444.g / 17;
