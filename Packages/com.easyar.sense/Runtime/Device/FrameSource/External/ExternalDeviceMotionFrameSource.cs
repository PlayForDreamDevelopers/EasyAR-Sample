...
namespace easyar
{
    ...
    public abstract class ExternalDeviceMotionFrameSource : ExternalDeviceFrameSource
    {
        ...
        /// </summary>
        protected bool HandleCameraFrameData(DeviceFrameSourceCamera deviceCamera, double timestamp, Image image, CameraParameters cameraParameters, Pose deviceToOriginTransform, MotionTrackingStatus trackingStatus, double frameRate = 0)
        {
            ...
            UnityEngine.Debug.LogWarning($"{nameof(HandleCameraFrameData)}: {timestamp}, {trackingStatus}, {deviceToOriginTransform.position}, {deviceToOriginTransform.rotation.eulerAngles}, fps: {frameRate:F2}");
#endif
